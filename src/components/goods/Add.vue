                ...
                <el-tabs :tab-position="'left'" v-model="activeIndex" :before-leave="beforeTabLeave"
                    ...
                    <el-tab-pane label="基本信息" name="0">
                        ...
                        <el-form-item label="商品分类" prop="goods_cat">
                            <el-cascader v-model="addForm.goods_cat" expandTrigger='hover' :options="cateList"
        ...
        methods: {
            ...
            add() {
                this.$refs.addFormRef.validate(async valid => {
                    ...
                    //这里会报错，因为cascader级联选择器通过v-model将数据双向绑定到addForm.goods_cat中，并且只允许是数组
                    //所以将this.addForm.goods_cat做一份深拷贝，通过改变拷贝的数据传给后台
